...
export const env = {
  ...
  HOST_MAIL_DEV: process.env.HOST_MAIL_DEV,
  PORT_MAIL_DEV: process.env.PORT_MAIL_DEV,
  USERNAME_MAIL_DEV: process.env.USERNAME_MAIL_DEV,
  PASSWORD_MAIL_DEV: process.env.PASSWORD_MAIL_DEV,
